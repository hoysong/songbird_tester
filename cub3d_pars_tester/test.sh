...
# the directory where test_files located.
test_dir=""

# valgrind flags.
valg_flag="--leak-check=full --show-leak-kinds=all --track-origins=yes"

valg_off=""
valg_on="valgrind $valg_flag"

run_valg="$valg_on"

prog_output=""

#it will put small banner.
put_small_banner() {
	echo =====================
	echo ******NEW_TEST!******
	echo =====================
...
run_test() {
	...
	for current_elmt in $dir_list
	do
		#print what test_file will passed.
		echo $On_ICyan === "$test_dir$current_elmt" === $Color_Off
